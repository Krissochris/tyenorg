      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('full_name') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" name="full_name" class="form-control" placeholder="{{ __('Full Name...') }}" value="{{ old('full_name') }}" required>
              </div>
