...
@section('title')
    {{ __('Create Tutor Agreement Attribute Option') }}
@stop
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5> Create Tutor Agreement Attribute Options </h5>
                </div>
                <div class="ibox-content table-responsive">
                    {!! Form::open(['route' => 'admin.tutor_agreement_attribute_options.create', 'enctype' => 'multipart/form-data']) !!}
