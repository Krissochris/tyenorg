            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($admin,['route' => ['admin.admins.edit', $admin->id]]) !!}
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="is_verified" type="checkbox" name="is_verified" value="1" {{ old('is_verified') ? 'checked' : ($admin->is_verified) ? 'checked' : '' }}>
                                    </div>
