<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li>
                <a href="{{ route('admin.reviews.index') }}"><i class="fa fa-blogger-b"></i> <span class="nav-label">Reviews</span>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.testimonies.index') }}"><i class="fa fa-blogger-b"></i> <span class="nav-label">Testimonies</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="css_animation.html"><i class="fa fa-magic"></i> <span
                        class="nav-label">CSS Animations </span><span class="label label-info float-right">62</span></a>
            </li>
