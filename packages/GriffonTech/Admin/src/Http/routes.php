...
Route::group(['middleware' => ['web']], function (){
    Route::prefix('admin')->group(function() {
        ...
        Route::get('admins/dashboard', 'GriffonTech\Admin\Http\Controllers\AdminsController@dashboard')->defaults('_config', [
            'view' => 'admin::admin.admins.dashboard'
        ])->name('admin.admins.dashboard');
