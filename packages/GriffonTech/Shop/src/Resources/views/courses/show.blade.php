        ...
        <div class="row">
                        ...
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <div class="card-title mb-0">
                                    <a href="student-profile.html" class="text-body"><strong> {{ $course->tutor->name }} </strong></a></div>
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                        <div class="flex">
                            <h4 class="card-header__title">Course Details</h4>
                        </div>
                    </div>
                    ...
                    <ul class="list-group list-group-fit">
                        ...
                        <li class="list-group-item active">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <a class="text-white" href="#">Asset Pipeline</a>
                                </div>
                                <div class="media-right">
                                    <small>18:43</small>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card card__course clear-shadow border">
                            ...
                            <div class="p-3">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <a class="text-body mb-1" href="fixed-#"><strong>UI/UX Basics</strong></a><br>
                                        <div class="d-flex align-items-center">
                                                    <span class="text-blue mr-1">
                                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="16" height="16" style="position:relative; top:-2px">
                                                            <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        <div class="card card__course clear-shadow border">
                            ...
                            <div class="p-3">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <a class="text-body mb-1" href="fixed-#"><strong>Learn Ruby on Rails</strong></a><br>
                                        <div class="d-flex align-items-center">
                                                    <span class="text-blue mr-1">
                                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="16" height="16" style="position:relative; top:-2px">
                                                            <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
