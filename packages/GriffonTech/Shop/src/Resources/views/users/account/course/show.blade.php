...
<div class="container">
    ...
    <div class="container">
        <div class="row bg-dark" style="padding: 20px 0;">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <small class="text-light">Purchased On: <span class="text-muted"> Date </span></small>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-group col-lg-12">
                            <li class="list-group-item"> course learning link : <a href="#">https://</a> </li>
                            <li class="list-group-item"> No of Users :  </li>
                            <li class="list-group-item"> Maximum Number of Users :  </li>
                            <li class="list-group-item"> Is Taken : No </li>
                            <li class="list-group-item"> Course Batch Taken on:  </li>
                        </ul>
                    </div>
                </div>
                <hr>
        ...
        @include("shop::partials.courses.tutor_detail")
        <hr>
