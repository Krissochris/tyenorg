    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="container col-md-10">
                <div class="row">
                    <?php $numberOfCourses = 8; ?>
                    @for($num = 0; $num <= $numberOfCourses; $num++)

                            <div class="col-lg-3 col-md-3 mb-3">
                                <div class="card h-100">
                                    <a href="{{ route('user.course.show') }}"><img class="card-img-top" src="{{ asset('images/cover.jpeg') }}"  alt=""></a>
                                    <div class="card-body">
                    ...
                    <div class="col-lg-3 col-md-3 mb-3">
                        <div class="card h-100">
                            <a href="#"><img class="card-img-top" src="{{ asset('images/cover.jpeg') }}"  alt=""></a>
                            <div class="card-body">
                                <p class="card-text">Some text!</p>
                            </div>
                            <div class="card-footer">
