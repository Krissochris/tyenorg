...
@section('content')
    ...
    <div class="container page__heading-container">
        <div class="page__heading d-flex align-items-center justify-content-between">
            <div>
                ...
                <p class="text-muted m-0">Welcome to <strong> {{ setting('application_name') }} </strong>  - Lets Grow Together </p>
            </div>
        </div>
    </div>
    ...
    <div class="container page__container">
        ...
        <div class="alert alert-soft-primary d-flex align-items-center" role="alert">
            ...
            <div class="text-body">
                <strong>Tip:</strong>
                Click <a href="{{ route('user.pro_user') }}">here</a> to become a life time pro member and enjoy the full benefits of the platform.
            </div>
        </div>
        @endif
...
--}}
            ...
            <div class="col-md-9">
                        ...
                        <div class="card card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h4 class="m-0 bold">{{ $myCoursesCount }}</h4>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <a href="#" class="text-muted mb-2"> Referral Bonus</a>
                                    <h4 class="m-0 bold">{{ ($user_referral->referral_bonus) ? $user_referral->referral_bonus : '0.00' }}</h4>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <a href="#" class="text-muted mb-2">Available Referrals</a>
                                    <h4 class="m-0 bold">{{ $user_referral->available_referral }}</h4>
                                </div>
                ...
                <div class="alert alert-soft-info d-flex align-items-center" role="alert">
                    ...
                    <div class="text-body"><strong>Referral Link - </strong>
