        ...
        <div class="sidebar sidebar-light sidebar-left bg-white" data-perfect-scrollbar>
                ...
                <div class="d-flex align-items-center sidebar-p-a border-bottom bg-light">
                    ...
                    <div class="dropdown ml-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="fixed-student-profile.html">My profile</a>
                            <a class="dropdown-item" href="fixed-student-edit-account.html">Edit account</a>
            ...
            <div class="sidebar-block p-0">
                ...
                <ul class="sidebar-menu mt-0">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-student-series.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-student-courses.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-sign-up.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                ...
                <ul class="sidebar-menu mt-0">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-instructor-course-edit.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-instructor-lesson-edit.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-instructor-create-quiz.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-instructor-payout.html">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
            ...
            <div class="sidebar-block p-0">
                <ul class="sidebar-menu" id="components_menu">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-ui-range-sliders.html">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-ui-datetime.html">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="fixed-ui-vector-maps.html">
