        ...
        <div class="sidebar sidebar-light sidebar-left bg-white" data-perfect-scrollbar>
            ...
            <div class="sidebar-block p-0">
                ...
                <ul class="sidebar-menu mt-0">
                    ...
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="{{ route('user.register.index') }}">
                            <span class="sidebar-menu-text">Create Account</span>
                        </a>
                    </li>
        ...
        @auth('user')
                    ...
                    <div class="sidebar-block p-0">
                        ...
                        <ul class="sidebar-menu mt-0">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('user.course.index') }}">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('user.referral.show') }}">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <span class="sidebar-menu-text">Referrals</span>
                                </a>
                            </li>


                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{ route('user.withdrawals.index') }}">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <span class="sidebar-menu-text">Request Withdrawal</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{route('user.purchases.index')}}">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <span class="sidebar-menu-text">Purchase Histories</span>
                                </a>
                            </li>


                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{route('user.blog.index')}}">
                                    <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                    ...
                                    <span class="sidebar-menu-text">My Blog Posts</span>
                                </a>
                            </li>


                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{route('user.testimonies.index')}}">
                                <span class="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
