...
namespace GriffonTech\Core;

use Carbon\Carbon;
use GriffonTech\Core\Repositories\CurrencyRepository;
use GriffonTech\Core\Repositories\ExchangeRateRepository;
use GriffonTech\Core\Repositories\CountryRepository;
use GriffonTech\Core\Repositories\CountryStateRepository;
use GriffonTech\Core\Repositories\LocaleRepository;
use GriffonTech\Core\Repositories\CoreConfigRepository;
...
class Core
{
     ...
     *
     * @param  \GriffonTech\Core\Repositories\CurrencyRepository     $currencyRepository
     * @param  \GriffonTech\Core\Repositories\ExchangeRateRepository $exchangeRateRepository
     * @param  \GriffonTech\Core\Repositories\CountryRepository      $countryRepository
     * @param  \GriffonTech\Core\Repositories\CountryStateRepository $countryStateRepository
     * @param  \GriffonTech\Core\Repositories\LocaleRepository       $localeRepository
     * @param  \GriffonTech\Core\Repositories\CoreConfigRepository   $coreConfigRepository
     * @return void
     */
